...
TEMPLATE_TEST_CASE("factorize_floori(), factorize_ceili()", "[arithmetic]", int)
{
    ...
    {
        using Tuple = std::tuple<TestType, TestType, TestType, TestType, TestType, TestType, TestType, TestType, TestType>;
        ...
        TestType x, a, b, floorExpA, floorExpB, floorR, ceilExpA, ceilExpB, ceilR;
        ...
        CHECK(slowmath::factorize_floori(x, a, b) == slowmath::factorization<TestType, 2>{ floorR, { floorExpA, floorExpB } });
        CHECK(slowmath::factorize_ceili(x, a, b) == slowmath::factorization<TestType, 2>{ ceilR, { ceilExpA, ceilExpB } });
    }
